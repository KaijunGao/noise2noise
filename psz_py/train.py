...
def get_args():
    ...
    parser.add_argument("--image_dir_1", type=str, default='/data_2/noise2noise/dataset_own/real.txt',
                        help="train image dir")
    parser.add_argument("--image_dir_2", type=str, default='/data_2/noise2noise/dataset_own/fake.txt',
                        help="train image dir")
    parser.add_argument("--test_dir_1", type=str,default='/data_2/noise2noise/dataset_own/val_real.txt',
                        help="test image dir")
    parser.add_argument("--test_dir_2", type=str,default='/data_2/noise2noise/dataset_own/val_fake.txt',
                        help="test image dir")
    ...
    parser.add_argument("--weight", type=str, default='/data_2/noise2noise/model_hdf5/weights.070-1877.918-16.53545.hdf5',
                        help="weight file for restart")
    parser.add_argument("--output_path", type=str, default="model_hdf5_rtof",
                        help="checkpoint dir")

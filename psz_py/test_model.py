...
def get_args():
    ...
    parser.add_argument("--image_dir", type=str,default='/data_2/noise2noise/test/img_batch2',
                        help="test image dir")
    parser.add_argument("--model", type=str, default="srresnet",
                        help="model architecture ('srresnet' or 'unet')")
    parser.add_argument("--weight_file", type=str, default='/data_2/noise2noise/model_hdf5/weights.070-1877.918-16.53545.hdf5',
    ...
    parser.add_argument("--output_dir", type=str, default='/data_2/noise2noise/test/out_img_batch2',
